...
export interface BlocksFeaturedArtcile extends Struct.ComponentSchema {
  collectionName: 'components_blocks_featured_artciles';
  info: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      'blocks.featured-artcile': BlocksFeaturedArtcile;
